...
async def cmd_start(message: Message):
    ...
    welcome_text = (
        ...
        f"• Протоколы VLESS + Reality (максимальная защита трафика)\n"
...
async def faq_handler(message: Message):
    text = (
        ...
        "Q: <b>Насколько стабильно подключение?</b>\n"
        "A: Мы используем протоколы VLESS + Reality, обеспечивающие надежное шифрование, анонимность и высокую скорость.\n\n"
        "Q: <b>Сколько устройств поддерживается?</b>\n"
        "A: Поддерживается работа до 2 устройств одновременно на одном аккаунте.\n\n"
